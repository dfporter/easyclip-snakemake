...
import scripts
import scripts.countsO, scripts.positiveCounts, scripts.negativeCounts
...
class statsForCounts():
    ...
    def __init__(
        self,
        negatives: Union[None, object, scripts.negativeCounts.negativeCounts]=None,
        positives: Union[None, object, scripts.positiveCounts.positiveCounts]=None,
        data_dir: str='./data/'):
