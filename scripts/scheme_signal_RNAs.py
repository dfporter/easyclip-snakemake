...
import scripts
import scripts.signal_RNAs
import scripts.scheme

importlib.reload(scripts.signal_RNAs)

class scheme_signal_RNAs(scripts.signal_RNAs.signal_RNAs):
    ...
    def add_scheme(self, scheme_fname=''):
        self.scheme = scripts.scheme.scheme(scheme_fname=scheme_fname)
