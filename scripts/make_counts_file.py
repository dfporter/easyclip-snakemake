...
import scripts.set_of_named_mRNAs
import scripts.exp
import scripts.metaExp
from docopt import docopt

importlib.reload(scripts.exp)
importlib.reload(scripts.rnaDataFileMaker)
importlib.reload(scripts.set_of_named_mRNAs)
...
ex = scripts.exp.exp(name=args['--name'], file_paths={
