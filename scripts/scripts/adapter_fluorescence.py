...
import scripts
import scripts.adapter_fluorescence_utils
...
def get_parameters(fname='180523.xlsx', sheet_name='180523_1'):
    ...
    #df, K = scripts.adapter_fluorescence_utils.get_Ka(df)
    df = df[df['fmols']<100]
    df = df[df['fmols']>3]
...
def get_parameters_and_draw_staple(fname='180523.xlsx', sheet_name='180523_1'):
    ...
    df = scripts.adapter_fluorescence_utils.load_sheet(fname=fname, sheet_name=sheet_name)
