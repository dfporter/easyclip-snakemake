...
class peakFinder():
    ...
    def __init__(
        ...
        rnas_obj: scripts.set_of_named_mRNAs.set_of_named_mRNAs=None):
...
#            max_index = random.choice(indexes_of_maxes)
    ...
    def find_peaks(
        ...
        for protein_name in df.columns:
            ...
            print("=" * 28, f"\nFinding peaks for {protein_name}...")
