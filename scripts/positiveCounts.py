...
import scripts.annCounts
import scripts.scheme
import scripts.biotypeUtils
import scripts.readsPerGene
importlib.reload(scripts.readsPerGene)
import scripts.readsPerGene as rpg
importlib.reload(scripts.annCounts)


class positiveCounts(scripts.annCounts.annCounts):
    ...
    def __init__(self, metadata, xl_rate_fname: str=''):
        ...
        self.scheme = scripts.scheme.scheme(metadata.scheme_file)
